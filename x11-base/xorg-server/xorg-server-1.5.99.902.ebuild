...
PDEPEND="
	xorg? (
		...
		input_devices_evdev? ( >=x11-drivers/xf86-input-evdev-2.1.1 )
		...
		video_cards_radeon? ( >=x11-drivers/xf86-video-ati-6.10.0 )
		...
		video_cards_vesa? ( >=x11-drivers/xf86-video-vesa-2.1.0 )

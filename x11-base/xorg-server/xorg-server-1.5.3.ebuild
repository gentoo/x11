...
UPSTREAMED_PATCHES=(
	"${FILESDIR}/1.5.3/0001-EXA-Avoid-some-fallbacks-in-exaCopyNtoN.patch"
	"${FILESDIR}/1.5.3/0002-EXA-Use-a-single-large-glyph-cache-pixmap.patch"
	"${FILESDIR}/1.5.3/0003-EXA-Add-exaCompositeRects.patch"
	"${FILESDIR}/1.5.3/0004-EXA-Fix-overlapping-glyphs-in-glyph-cache.patch"
	"${FILESDIR}/1.5.3/0005-EXA-Clean-up-debug-messages.patch"
	"${FILESDIR}/1.5.3/0006-EXA-Use-UploadToScreen-for-uploads-to-glyph-cache.patch"
	"${FILESDIR}/1.5.3/0007-EXA-Glyph-cache-upload-tweaks.patch"
	"${FILESDIR}/1.5.3/0008-EXA-Accumulate-glyphs-whenever-possible-for-full-b.patch"
	"${FILESDIR}/1.5.3/0009-EXA-Try-to-accelerate-non-antialiased-text-via-the.patch"
	"${FILESDIR}/1.5.3/0010-EXA-Fall-back-in-CompositeRects-if-the-driver-can-t.patch"
	"${FILESDIR}/1.5.3/0011-EXA-Only-record-damage-generated-by-rendering-opera.patch"
	"${FILESDIR}/1.5.3/0012-EXA-Optimize-GXcopy-tiled-fills.patch"
	"${FILESDIR}/1.5.3/0013-EXA-Simplify-exaFillRegionTiled-control-flow.patch"
	"${FILESDIR}/1.5.3/0014-EXA-Fix-exponential-growth-logic-for-GXcopy-tiled-f.patch"
	"${FILESDIR}/1.5.3/0015-EXA-Do-still-return-FALSE-if-the-driver-PrepareCopy.patch"
	"${FILESDIR}/1.5.3/0016-EXA-Remove-unnecessary-includes.patch"
	"${FILESDIR}/1.5.3/0017-EXA-Make-sure-damage-tracking-code-is-inactive-if-t.patch"
	"${FILESDIR}/1.5.3/0018-EXA-Don-t-use-exaGlyphs-if-the-driver-doesn-t-provi.patch"
	"${FILESDIR}/1.5.3/0019-EXA-Inline-Prepare-FinishAccessWindow-into-only-cal.patch"
	"${FILESDIR}/1.5.3/0020-exa-remove-useless-cache-X-Y-off-from-UploadToScree.patch"
	"${FILESDIR}/1.5.3/0021-exa_glyphs-remove-useless-offset.patch"
	"${FILESDIR}/1.5.3/0022-exa-move-destination-damage-for-internal-calls-to-a.patch"
	"${FILESDIR}/1.5.3/0023-exa-report-damage-manually-for-exa-Trapezoids-Trian.patch"
	"${FILESDIR}/1.5.3/0024-exa-some-minor-cleanup.patch"
	"${FILESDIR}/1.5.3/0025--damage-exa-sanitise-damage.patch"
	"${FILESDIR}/1.5.3/0026-damage-choose-less-ambiguous-function-names.patch"
	"${FILESDIR}/1.5.3/0027-exa-drop-cw.h-inclusion.patch"
	"${FILESDIR}/1.5.3/0028-exa-disable-shared-pixmaps.patch"
	"${FILESDIR}/1.5.3/0029-exa-make-sure-pixmap-devPrivate.ptr-is-NULL-at-crea.patch"
	"${FILESDIR}/1.5.3/0030-exa-remove-some-excessive-whitespace.patch"
	"${FILESDIR}/1.5.3/0031-exa-remove-direct-case-for-exa-Trapezoids-Triangl.patch"
	"${FILESDIR}/1.5.3/0032-exa-don-t-call-composite-routines-with-no-buffer.patch"
	"${FILESDIR}/1.5.3/0033-exa-restore-x-y-Src-Dst-to-their-original-values.patch"

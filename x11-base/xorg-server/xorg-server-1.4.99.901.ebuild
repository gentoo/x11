...
PDEPEND="
	xorg? (
		...
		input_devices_dmc? ( >=x11-drivers/xf86-input-dmc-1.1.1 )
		...
		input_devices_evdev? ( >=x11-drivers/xf86-input-evdev-1.1.5 )
		...
		input_devices_joystick? ( >=x11-drivers/xf86-input-joystick-1.3.1 )
		input_devices_keyboard? ( >=x11-drivers/xf86-input-keyboard-1.2.2 )
		...
		input_devices_mouse? ( >=x11-drivers/xf86-input-mouse-1.2.3 )
		...
		input_devices_vmmouse? ( >=x11-drivers/xf86-input-vmmouse-12.4.3 )
...
PATCHES="
	...
	${FILESDIR}/0001-Fix-segfault-when-a-monitor-exists-but-has-no-modes.patch
	${FILESDIR}/0002-Size-xf86DefaultModes-explicitly.patch
	${FILESDIR}/0003-Bug-14927-Fix-the-math-for-xf86NumDefaultModes.patch
	${FILESDIR}/0004-Add-the-amd-driver-to-magic-driver-selection.patch
...
src_unpack() {
	...
	if use kdrive; then
		kdrive_setup
		# Missing from 1.4.99.901 tarball
		cp "${FILESDIR}"/ephyrdriext.h "${S}"/hw/kdrive/ephyr/ || die
	fi
